...
project = u'python-deltasigma'
copyright = u'2013-2015, Giuseppe Venturini'
...
from deltasigma_theme import deltasigma_theme_path
html_theme_path = [deltasigma_theme_path]
html_theme = 'deltasigma_theme'

html_title = "python-deltasigma v{release} documentation".format(release=release)
...
htmlhelp_basename = 'python-deltasigmadoc'
...
man_pages = [
    ('index', 'python-deltasigma', u'python-deltasigma Documentation',
     [u'Giuseppe Venturini'], 1)
]
...
texinfo_documents = [
  ('index', 'python-deltasigma', u'python-deltasigma Documentation',
   u'Giuseppe Venturini', 'python-deltasigma', 'One line description of project.',
   'Miscellaneous'),
]
